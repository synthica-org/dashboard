...
const CERT_META = {
  associate: { label: 'Associate Researcher', template: '/assets/certs/associate.jpg', blurb: 'For contributing to a published research project.' },
  independent: { label: 'Independent Researcher', template: '/assets/certs/independent.jpg', blurb: 'For independently driving a research project.' },
  lead: { label: 'Lead Researcher', template: '/assets/certs/lead.jpg', blurb: 'For leading a team to a publishable result.' },
  chapter: { label: 'Chapter Leader', template: '/assets/certs/chapter.jpg', blurb: 'For founding and running a Synthica chapter.' },
};
