          ...
          it.type === 'activity' ? (
            ...
            <Card key={i}>
              ...
              <div style={{ marginTop: '0.25rem' }}>
                {it.doi ? <Link to={`/article/${encodeURIComponent(it.doi)}`}>{it.body || ''}</Link> : (it.body || '')}
              </div>
    ...
    <section style={{ marginBottom: '2rem' }}>
      ...
      <Card>
        ...
        <p className="muted" style={{ marginBottom: 0 }}>
          When your draft is ready, <Link to="/researcher/journal">submit it to the journal</Link> — the
          pipeline walks you through review to publication.
        </p>
      </Card>
    </section>
  );
